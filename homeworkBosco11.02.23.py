...
if __name__ == "__main__":
    ...
    sin = Button(root, text='sin', fg='black', bg='azure',
                 command=sin, height=4, width=7)
    sin.grid(row=6, column=1)

    cos = Button(root, text='cos', fg='black', bg='azure',
                 command=cos, height=4, width=7)
    cos.grid(row=6, column=2)

    tan = Button(root, text='tan', fg='black', bg='azure',
                 command=tan, height=4, width=7)
